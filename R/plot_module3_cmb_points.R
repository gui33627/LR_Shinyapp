...
plot_module3_cmb_points <- function(group0 = FALSE, group1 = FALSE, data_current = NULL, data_0 = NULL, data_1 = NULL, done = FALSE,
                                    formula, intercept_assess_draw_cmb, b1_assess_draw_cmb, b2_assess_draw_cmb, b3_assess_draw_cmb, 
                                    data_0_fit = NULL, data_1_fit = NULL){
  ...
  if(group0 ==TRUE & group1 == FALSE){
    ...
    colors <- c("Your points for group0" = "blue", "Your points for group1" = "red", "True line for group0" = "black", "True line for group1" = "brown")
    ggplot() + geom_point(data = data_0, aes(x, y, color = "Your points for group0")) + 
      ...
      colors <- c("Your points for group0" = "blue", "Your points for group1" = "red", "Your line for group0" = "cyan", "Your line for group1" = "orange", "True line for group0" = "black", "True line for group1" = "brown")
      ggplot() + geom_point(data = data_0, aes(x, y, color = "Your points for group0")) + 
        geom_point(data = data_1, aes(x, y, color = "Your points for group1")) + 
