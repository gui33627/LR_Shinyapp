...
plot_module4_cpb <- function(line = FALSE, submit = FALSE, data_0, data_1, formula = NULL, b0 = NULL, b1 = NULL, b2 = NULL){
  ...
  if(line == TRUE){
    if(submit == TRUE){
      ...
      ggplot() +
        ...
        geom_abline(aes(intercept = b0 + b2, slope = b1, color = "Your line for group1"), show.legend = FALSE) +
