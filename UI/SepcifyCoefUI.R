               ...
               mainPanel(
                 tabsetPanel(
                   tabPanel("Introdution", fluidRow( tags$div(
                     ...
                     p("Philosophy 1: There is a true model that generated the data and we need to find it.",tags$br(),
                       "Philosophy 2: We will find the model that best explains or predicts our data, and interpret our results in light of the fact that there may be missing covariates."),
